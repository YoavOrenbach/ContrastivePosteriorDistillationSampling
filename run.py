...
def main():
    ...
    parser.add_argument('--w_cut', type=float, default=3.0, help="weight coefficient for cut loss term") #5.0
    ...
    parser.add_argument("--config", type=str, default="cpds", choices=["dds", "cds", "pds", "cpds"], help="framework configuration")
    parser.add_argument("--patch_selector", type=str, default="random", choices=["random", "meta", "svm", "knn", "rf"], help="patch selection method")
